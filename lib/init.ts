...
const categories: FileCategory[] = [
  ...
  },
  {
    ...
    files: [
      { src: 'skills/v1/generate-atom.prompt.md', dest: '.github/skills/generate-atom/SKILL.md' },
      { src: 'skills/v1/generate-molecule.prompt.md', dest: '.github/skills/generate-molecule/SKILL.md' },
      { src: 'skills/v1/generate-organism.prompt.md', dest: '.github/skills/generate-organism/SKILL.md' },
      { src: 'skills/v1/generate-page.prompt.md', dest: '.github/skills/generate-page/SKILL.md' },
    ],
  },
  {
    ...
    description: 'Skills for generating atoms, molecules, organisms, and pages',
    files: [
      { src: 'skills/v2/generate-atom.prompt.md', dest: '.github/skills/generate-atom/SKILL.md' },
      { src: 'skills/v2/generate-molecule.prompt.md', dest: '.github/skills/generate-molecule/SKILL.md' },
      { src: 'skills/v2/generate-organism.prompt.md', dest: '.github/skills/generate-organism/SKILL.md' },
      { src: 'skills/v2/generate-page.prompt.md', dest: '.github/skills/generate-page/SKILL.md' },
    ],
  },
  {
    ...
    files: [
      { src: 'skills/v1/tpl-component.prompt.md', dest: '.github/skills/tpl-component/SKILL.md' },
      { src: 'skills/v1/tpl-template.prompt.md', dest: '.github/skills/tpl-template/SKILL.md' },
      { src: 'skills/v1/tpl-page.prompt.md', dest: '.github/skills/tpl-page/SKILL.md' },
      { src: 'skills/v1/tpl-page-story.prompt.md', dest: '.github/skills/tpl-page-story/SKILL.md' },
      { src: 'skills/v1/tpl-data.prompt.md', dest: '.github/skills/tpl-data/SKILL.md' },
      { src: 'skills/v1/tpl-state.prompt.md', dest: '.github/skills/tpl-state/SKILL.md' },
      { src: 'skills/v1/tpl-style.prompt.md', dest: '.github/skills/tpl-style/SKILL.md' },
      { src: 'skills/v1/tpl-type.prompt.md', dest: '.github/skills/tpl-type/SKILL.md' },
    ],
  },
  {
    ...
    description: 'Template blueprints for component, wrapper, page, data, state, style, and type files',
    files: [
      { src: 'skills/v2/tpl-component.prompt.md', dest: '.github/skills/tpl-component/SKILL.md' },
      { src: 'skills/v2/tpl-template.prompt.md', dest: '.github/skills/tpl-template/SKILL.md' },
      { src: 'skills/v2/tpl-page.prompt.md', dest: '.github/skills/tpl-page/SKILL.md' },
      { src: 'skills/v2/tpl-page-story.prompt.md', dest: '.github/skills/tpl-page-story/SKILL.md' },
      { src: 'skills/v2/tpl-data.prompt.md', dest: '.github/skills/tpl-data/SKILL.md' },
      { src: 'skills/v2/tpl-state.prompt.md', dest: '.github/skills/tpl-state/SKILL.md' },
      { src: 'skills/v2/tpl-style.prompt.md', dest: '.github/skills/tpl-style/SKILL.md' },
      { src: 'skills/v2/tpl-type.prompt.md', dest: '.github/skills/tpl-type/SKILL.md' },
    ],
  },
  {
    name: 'Utility Skills',
    ...
    files: [
      { src: 'skills/resolve-model-properties.prompt.md', dest: '.github/skills/resolve-model-properties/SKILL.md' },
    ],
  },
  // {
