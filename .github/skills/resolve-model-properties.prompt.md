...
## Scope of Resolved Properties

Resolved properties affect ONLY these specific parts of the generated files:

- **`tpl-type`** — properties become optional fields in the interface
- **`tpl-component`** — properties appear ONLY in the destructuring line (`const { ... } = model;`)

Properties must NEVER cause extra JSX elements, HTML tags, CSS rules, wrapper components, or any other invented content in any generated file. The JSX body of the component remains empty regardless of properties.
