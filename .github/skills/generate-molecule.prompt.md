...
- The type file uses **append** mode — add the new interface to the very BOTTOM (end) of `src/_types/molecules.d.ts`. NEVER prepend to the top or insert before existing interfaces. All existing content must remain unchanged above the new interface
